...
1. **AI-Assisted Contributions**: We welcome the use of AI tools throughout the codebase. All AI-generated code must be properly tagged and validated. See our comprehensive [AI Contributions Guide](docs/AI_CONTRIBUTIONS.md) for detailed requirements including:
   - Tagging requirements for all AI-generated code
   - Legal compliance and validation procedures
   - Security considerations for cryptographic code
   - Best practices and examples
   - Code review process for AI-assisted contributions
