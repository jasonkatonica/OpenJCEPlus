...
public class BaseTestAESCCMInteropBC extends BaseTestJunit5Interop {
    ...
    public void testAESCCMDoFinalWithInputSliceInterop() throws Exception {
        ...
        // at offset 40 — so inputLen (20) << input.length (100).
        ...
        // input.length + tagLenInBytes would be 116, which is larger than the output buffer.
        ...
        // input.length - tagLenInBytes would be 84, which is larger than the output buffer.
